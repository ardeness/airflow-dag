...
def create_dag(schedule, default_args):
    ...
    asr_compute_resources = k8s.V1ResourceRequirements(
       requests={"nvidia.com/gpu": "1", "memory": "128Gi"},
    ...
    with dag:
        ...
        srt_correction =  KubernetesPodOperator(
            ...
            image_pull_secrets=[k8s.V1LocalObjectReference("ecr")],
            image_pull_policy='Always',
            cmds = ["python", "correction.py", "/opt/data/"+file_prefix+"_sync_post.score", collection],
        ...
        cleanup =  KubernetesPodOperator(
            ...
            image_pull_secrets=[k8s.V1LocalObjectReference("ecr")],
            image_pull_policy='Always',
            cmds = ["python", "cleanup.py", file_prefix+"_sync_post.srt", file_prefix+"_sync_post.score", file_prefix+"_sync_post_rag.score"],
